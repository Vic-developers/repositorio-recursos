...
// Override parent/top so SCORM content finds API even when using window.parent.API
...
JS;
        ...
        // Inject API script and base tag right after <head> (before any SCORM scripts)
